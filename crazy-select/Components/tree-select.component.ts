...
import {Component, forwardRef, Input, OnInit, HostListener, ViewEncapsulation} from '@angular/core';
...
export class TreeSelectComponent implements ControlValueAccessor {
  ...
  @Input() public filterPlaceholder = '过滤...';
  @Input() public allowFilter = false;
  ...
  public constructor(
    ...
    this.filterPlaceholder = (defaultOpts.filterPlaceholder || '请输入您要查询的科室');
